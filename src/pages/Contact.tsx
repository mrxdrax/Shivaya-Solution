            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                <motion.a
                  ...
                  className="flex items-center space-x-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 scale-hover"
                >
                  <div className="p-3 bg-brand-warm-orange/10 rounded-lg">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-warm-orange/10 rounded-full flex items-center justify-center mx-auto mb-4">
